    ...
    <main>
        ...
        <div className='codeInput' style={{display: open}}>
            ...
            <div className="review-btn" onClick={handleClick}>
                <p>Review <i className="ri-arrow-right-line"></i></p>
            </div>
        </div>
        ...
        {loading ? <p>Analysing your code...</p> : <Markdown>{review}</Markdown>}
        {error && <p>❌Error occurred while analyzing code.Sorry for the inconvenience caused😢</p>}
        </div>
    </main>
    </>
  )
